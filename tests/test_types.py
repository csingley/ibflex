...
class StatementOfFundsLineTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        self.assertEqual(instance.model, None)
        self.assertEqual(instance.currency, "USD")
        self.assertEqual(instance.assetCategory, Types.Asset.STOCK)
...
class FxLotTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        self.assertEqual(instance.acctAlias, "ibflex test")
        self.assertEqual(instance.model, None)
        self.assertEqual(instance.assetCategory, Types.Asset.CASH)
...
class TradeTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        self.assertEqual(instance.assetCategory, Types.Asset.OPTION)
...
class TradeTransferTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        self.assertEqual(instance.direction, Types.ToFrom.FROM)
...
class TransferTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        self.assertEqual(instance.direction, Types.InOut.IN)
