...
class StatementOfFundsLineTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        self.assertEqual(instance.date, datetime.date(2011, 12, 27))
...
class FxLotTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        self.assertEqual(instance.acctAlias, "ibflex test")
        self.assertEqual(instance.model, None)
        self.assertEqual(instance.assetCategory, "CASH")
...
class TradeTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        self.assertEqual(instance.assetCategory, "OPT")
        ...
        self.assertEqual(instance.transactionType, Types.TradeType.BOOKTRADE)
        self.assertEqual(instance.exchange, "--")
        ...
        self.assertEqual(instance.buySell, Types.BuySell.BUY)
        ...
        self.assertEqual(instance.exchOrderId, "N/A")
        self.assertEqual(instance.extExecID, "N/A")
...
class TradeTransferTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        self.assertEqual(instance.transactionType, Types.TradeType.DVPTRADE)
        self.assertEqual(instance.exchange, "--")
        ...
        self.assertEqual(instance.direction, Types.TradeTransferDirection.FROM)
        self.assertEqual(instance.deliveredReceived, Types.DeliveredReceived.RECEIVED)
...
class CashTransactionTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        self.assertEqual(instance.putCall, None)
        self.assertEqual(instance.principalAdjustFactor, None)
        self.assertEqual(instance.dateTime, datetime.date(2015, 10, 6))
...
class TransferTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        self.assertEqual(instance.type, Types.TransferType.ACATS)
        self.assertEqual(instance.direction, Types.TransferDirection.IN)
        self.assertEqual(instance.company, "--")
